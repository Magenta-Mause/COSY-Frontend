...
export const FileBrowserRow = ({
  ...
  const hasMenu = onDownload || (onEdit && editable) || onRename || onChangePermissions || onDelete;
  ...
  return (
    ...
    <div
      ...
      onKeyDown={
        onEntryClick
          ? (e) => {
              if (e.key === "Enter" || e.key === " ") onEntryClick(obj);
            }
          : undefined
      }
      className={cn(
        ...
        <div className="self-center shrink-0" onClick={(e) => e.stopPropagation()}>
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end">
              ...
              {onDownload && !dir && (
                <DropdownMenuItem onClick={() => onDownload(obj)} disabled={isBeingDownloaded}>
              ...
              {/* Write actions */}
              {canWrite && (onRename || onChangePermissions) && <DropdownMenuSeparator />}
              {onRename && (
