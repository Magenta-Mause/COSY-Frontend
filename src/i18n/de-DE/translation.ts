    ...
    GameServerSettings: {
      ...
      webhooks: {
        ...
        form: {
          ...
          httpMethod: "Request-Methode",
          headers: "Request-Header",
          headerName: "Name",
          headerValue: "Wert",
          addHeader: "Header hinzufügen",
          bodyTemplate: "Request-Body",
          placeholderHint: "Verfügbare Platzhalter für Header-Werte und den Request-Body:",
        },
        ...
        validation: {
          ...
          headerNameRequired: "Jeder Header benötigt einen Namen",
          headerNameInvalid:
            "Header-Namen dürfen nur Buchstaben, Ziffern und !#$%&'*+-.^_`|~ enthalten",
          headerNameReserved:
            "Dieser Header wird von Cosy gesetzt und kann nicht überschrieben werden",
          headerNameDuplicate: "Header-Namen müssen eindeutig sein",
          headerValueTooLong: "Header-Wert ist zu lang",
          headersTooMany: "Es können höchstens 20 Header konfiguriert werden",
          bodyTemplateTooLong: "Request-Body ist zu lang",
        },
        cancel: "Abbrechen",
        creating: "Wird erstellt...",
        edit: "Bearbeiten",
