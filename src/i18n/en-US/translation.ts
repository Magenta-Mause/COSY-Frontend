  ...
  components: {
    ...
    fileBrowser: {
      ...
      fileBrowserDialog: {
        ...
        editFileFetchError: "Failed to load file for editing.",
        errorWhileDownload: "Failed to download file",
      },
      uploadArchiveModal: {
        ...
        extractionFailed: "Extraction failed. Make sure the file is a valid ZIP archive.",
        cancel: "Cancel",
        clearExistingLabel: "Clear existing files",
        clearExistingWarning:
          "Be careful — all existing files in the target directory will be permanently deleted before extraction.",
        clearConfirmTitle: "Clear existing files?",
        clearConfirmDescription:
          "This will permanently delete all files in the target directory before extracting the archive. This action cannot be undone.",
        clearConfirmCancel: "Cancel",
        clearConfirmProceed: "Delete & Extract",
      },
      downloadModal: {
        title: "Download Directory",
        sizeLabel: "Uncompressed size",
        sizeNote: "Actual ZIP may be smaller due to compression.",
        calculatingSize: "Calculating...",
        uncompressedSize: "Uncompressed size: {{size}}",
        chunkSizeLabel: "Chunk size",
        firefoxWarning:
          "Your browser doesn't support streaming downloads. Files larger than ~500 MB may fail or crash the tab. Use Chrome or Edge for large directories, or use Split Chunks below.",
        downloadSingle: "Download as Single File",
        downloadSplit: "Download as Split Chunks",
        mbPerChunk: "MB per chunk",
        splitNote:
          "Each chunk is an independent ZIP. Individual files larger than the chunk size are not split.",
      },
      editFileModal: {
        title: "Edit {{name}}",
        ...
        saving: "Saving...",
        cancel: "Cancel",
        saveError: "Failed to save file. Please try again.",
      },
      changePermissionsModal: {
        ...
        write: "Write",
        execute: "Execute",
        ownerLabel: "Owner (UID)",
        ownerNote: "Changes the owning user of the file. Requires elevated privileges.",
        save: "Save",
        saving: "Saving...",
        cancel: "Cancel",
        saveError: "Failed to update permissions. Please try again.",
      },
    },
    ...
    GameServerSettings: {
      ...
      webhooks: {
        ...
        form: {
          ...
          placeholderHint: "Available placeholders for header values and the request body:",
        },
        ...
        validation: {
          ...
          headerNameRequired: "Every header needs a name",
          headerNameInvalid: "Header names may only contain letters, digits and !#$%&'*+-.^_`|~",
          headerNameReserved: "This header is set by Cosy and cannot be overridden",
          headerNameDuplicate: "Header names must be unique",
          headerValueTooLong: "Header value is too long",
          headersTooMany: "At most 20 headers can be configured",
          bodyTemplateTooLong: "Request body is too long",
        },
        cancel: "Cancel",
        creating: "Creating...",
        edit: "Edit",
